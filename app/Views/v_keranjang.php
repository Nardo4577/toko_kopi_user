...
<html lang="en">
    <head>
        ...
        <style>
            ...
            .btn-checkout { background-color: #8d6e63; color: white; width: 100%; padding: 12px; font-size: 16px; font-weight: bold; border: none; border-radius: 5px; transition: 0.3s; text-transform: uppercase; margin-top: 20px; }
            ...
            .fixedArea {
                z-index: 9999 !important; /* Mencegah navbar tertabrak elemen lain */
                position: fixed; /* Memastikan navbar menempel di atas */
                ...
                <div class="row">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        <td style="text-align: left;">
                                            <div class="row">
                                                <div class="col-md-4 col-sm-4 col-xs-4">
                                                    <img src="https://images.unsplash.com/photo-1578314675249-a6910f80cc4e?auto=format&fit=crop&w=200&q=80" class="cart-item-img" alt="Kopi">
                                                </div>
                                                <div class="col-md-8 col-sm-8 col-xs-8">
                                                    <div class="product-name">Es Kopi Susu Senja</div>
                                                    <small style="color: #777;">Less Sugar, Normal Ice</small>
                                                </div>
                                            </div>
                                        </td>
                                        <td>Rp 20.000</td>
                                        ...
                                        <td style="font-weight: bold; color: #8d6e63;">Rp 40.000</td>
                                        <td>
                                            <a href="#" class="btn-remove" title="Hapus Item"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td style="text-align: left;">
                                            <div class="row">
                                                <div class="col-md-4 col-sm-4 col-xs-4">
                                                    <img src="https://images.unsplash.com/photo-1485808191679-5f86510681a2?auto=format&fit=crop&w=400&q=80" class="cart-item-img" alt="Kopi">
                                                </div>
                                                <div class="col-md-8 col-sm-8 col-xs-8">
                                                    <div class="product-name">Caramel Macchiato</div>
                                                    <small style="color: #777;">Standard</small>
                                                </div>
                                            </div>
                                        </td>
                                        <td>Rp 25.000</td>
                                        ...
                                        <td style="font-weight: bold; color: #8d6e63;">Rp 25.000</td>
                                        <td>
                                            <a href="#" class="btn-remove" title="Hapus Item"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                    ...
                    <div class="col-md-4 col-sm-12">
                        <div class="summary-card">
                            ...
                            <button class="btn-checkout"><i class="fa fa-lock"></i> Lanjut Pembayaran</button>
